			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><input type="text" class="form-control" placeholder="Nom d'utilisateur" aria-describedby="sizing-addon2"></li>
						<li><input type="text" class="form-control" placeholder="Mot de passe" aria-describedby="sizing-addon2"></li>
					</ul>
				</li>
			</ul>
